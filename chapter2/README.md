...
All other 3D nodes, such as [Camera](https://docs.godotengine.org/en/stable/classes/class_spatial.html), which we'll add next, are sublcasses of [Spatial](https://docs.godotengine.org/en/stable/classes/class_spatial.html).
